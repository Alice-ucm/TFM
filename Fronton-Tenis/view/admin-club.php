         ...
         <h3 class="title">Club
	         ...
	         <div class="container">    
	           <table id="tablax" class="table table-striped table-bordered" style="width:100%">
				...
				<tbody>
					<?php
							$query="SELECT *FROM club ORDER BY id_club DESC";
					...
					?>		
						...
						<td><?php echo $mostrar['id_club']?></td>
							<td><?php echo $mostrar['nombre']?></td>
							<td><?php echo $mostrar['email']?></td>
							<td><?php echo $mostrar['telefono']?></td>
							<td><?php
									if($mostrar['estado']==0){
										echo '<p><a class="label label-warning" href="../model/estado-c.php?id_club='
											   .$mostrar['id_club'].'&estado=1">Dar alta
										</a></p>';
									}else{
										echo '<p><a class="label label-success" href="../model/estado-c.php?id_club='
										.$mostrar['id_club'].'&estado=0">Activo
								 </a></p>';
									}
			
								?>
							</td>
							<td><a class="label label-info" href="../view/editar-cu.php?id_club=<?php echo $mostrar['id_club']?>">editar</a>
							<a class="label label-danger" href="../model/eliminar-cu.php?id_club=<?php echo $mostrar['id_club']?>">Eliminar</a>
							</td>
...
<div class="footer">
		<div class="container">
			...
			<div class="w3agile_footer_copy">
				<p>© 2022 Frontenón-Tenis. All rights reserved | Design by
					<a href="">UCM.</a>
				</p>
			</div>
		</div>
