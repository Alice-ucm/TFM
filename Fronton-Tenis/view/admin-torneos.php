	       ...
	       <table id="tablax" class="table table-striped table-bordered" style="width:100%">
				...
				<tbody>
					<?php
							...
							$query="SELECT *FROM torneos ORDER BY id_torneo DESC";
					...
					?>		
						...
						<td><?php echo $mostrar['club_creador']?></td>
							<td><?php echo $mostrar['titulo']?></td>
							<td><?php echo $mostrar['pais']?></td>
							<td><?php echo $mostrar['provincia']?></td>
							<td><?php
									if($mostrar['estado']==1){
										echo '<a href="" class="label label-success"> Activo </a>';
									}else{
										echo '<a href="" class="label label-warning">Dar alta</a>';
									}
								?>
							</td>
							<td><a class="label label-info" href="../view/editar-trc.php?id_torneo=<?php echo $mostrar['id_torneo']?>">editar</a>
							<a class="label label-danger" href="../model/eliminar-tra.php?id_torneo=<?php echo $mostrar['id_torneo']?>">Eliminar</a>
							</td>
