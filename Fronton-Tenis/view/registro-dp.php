...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO users (name,email,password,rol) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "', '" . $rol . "')")) {
			...
			//Error si no se logra ingresar los datos con exito
			$errormsg = '
...
<head>
	<title>Login-Deportista</title>
	<!-- Meta tag Keywords -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="UTF-8" />
	<meta name="keywords" content="Tennis Hub Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"
	/>
	<script>
...
<body>
	...
	<div class="about" id="about">
		<div class="container">
			<h3 class="title">
				<img src="../images/logo2.png" alt="" />Deportista
			</h3>
			<div class="about-top">
        ...
        <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="hidden" name="rol" placeholder="rol"  value="1" class="" />
