	...
	<div class="news-section" id="event"> 
	     <div class="container">
              <h3 class="title">Usuarios
				<img src="../images/logo2.png" alt=""/><br> </h3>
	          <div class="container">    
	            <table id="tablax" class="table table-striped table-bordered" style="width:100%">
				    ...
				    <tbody>
					    <?php
							$query="SELECT *FROM users ORDER BY id_usuario DESC ";
						...
						<tr>
							...
							<td><?php
								if($mostrar['estado']==0){
									echo '<p><a class="label label-warning" href="../model/estado-u.php?id_usuario='
										.$mostrar['id_usuario'].'&estado=1">Dar alta
									 </a></p>';
								}else{
									echo '<p><a class="label label-success" href="../model/estado-u.php?id_usuario='
									.$mostrar['id_usuario'].'&estado=0">Activo
							        </a></p>';
								 }
							...
							<td>
								<a class="label label-info" href="editar-us.php?id_usuario=<?php echo $mostrar['id_usuario']?>">Editar</a>
							    <a class="btn btn-danger btn-sm" href="../model/eliminar-us.php?id_usuario=<?php echo $mostrar['id_usuario']?>">Eliminar</a>
							</td>	
						</tr>
						<?php
					       }
